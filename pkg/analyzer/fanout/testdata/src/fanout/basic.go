...
func HighFanOut() { // want `function HighFanOut has fan out of 7 \(warn: >=7, fail: >=10\) \[warning\] \(reduce by extracting groups of related calls into helper functions to limit direct dependencies; if this is a simple routing switch, consider override //complexity:fanout:warn=N,fail=N Simple routing switch.\)`
	_ = dep.A()
	_ = dep.B()
	_ = dep.C()
	_ = dep.D()
...
func FuncLitFanOut() { // want `function FuncLitFanOut has fan out of 7 \(warn: >=7, fail: >=10\) \[warning\] \(reduce by extracting groups of related calls into helper functions to limit direct dependencies; if this is a simple routing switch, consider override //complexity:fanout:warn=N,fail=N Simple routing switch.\)`
	fn := func() {
		_ = dep.A()
		_ = dep.B()
		_ = dep.C()
...
func GoFuncFanOut() { // want `function GoFuncFanOut has fan out of 7 \(warn: >=7, fail: >=10\) \[warning\] \(reduce by extracting groups of related calls into helper functions to limit direct dependencies; if this is a simple routing switch, consider override //complexity:fanout:warn=N,fail=N Simple routing switch.\)`
	go func() {
		_ = dep.A()
		_ = dep.B()
		_ = dep.C()
